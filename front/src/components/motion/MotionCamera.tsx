...
export default function MotionCamera(){
  useEffect(() => {
    ...
    // moiton을 그릴 HTML
    const motionSection = document.getElementById("motion") as HTMLCanvasElement | null;
  ...
  return (
    <div id="motion" className="invisible">
      ...
      <button id="webcamButton" style={{ backgroundColor: "white", color: "black" }}>ENABLE PREDICTIONS</button>
    </div>
  );
}
